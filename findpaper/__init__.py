...
#     This function:
#       1. Searches for papers published in the last 30 days related to 'simplex regression model'.
#       2. Downloads the first two papers.
#       3. Prints details of the first paper.
#     """
#     try:
#         downloader = ArxivDownloader()

#         # Search for recent papers about "simplex regression model"
...
#             max_results=20,
#             sort_by='relevance', # ou "submittedDate", "lastUpdatedDate"
...
#             pdf_urls = results['pdf_url'].tolist()
#             downloaded_files = downloader.download_papers(
#                 pdf_urls[:2],
#                 skip_existing=True,   # Skip if already exists
#                 concurrency=1         # Sequential; set higher for parallel
#             )
#             print(f"\nDownloaded files: {downloaded_files}")

#             # Get detailed information for the first paper
#             arxiv_id = results.iloc[0]['arxiv_id']
#             details = downloader.get_paper_details(arxiv_id)
#             print(f"\nDetailed information for the first paper:")
#             print(json.dumps(details, indent=2))

#             # Optionally save results to a CSV or JSON
#             downloader.save_results_to_csv(results, "arxiv_results.csv")
#             downloader.save_results_to_json(results, "arxiv_results.json")
